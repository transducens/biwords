...
# This script reads GIZA++ alignments and proccess them giving as an
# output a more human (and machine) readable format with the same
# information. From this new format it is easier to construct an
